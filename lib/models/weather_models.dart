import 'dart:convert';
/// coord : {"lon":15.709,"lat":50.814}
/// weather : [{"id":804,"main":"Clouds","description":"overcast clouds","icon":"04d"}]
/// base : "stations"
/// main : {"temp":278.01,"feels_like":271.01,"temp_min":276.72,"temp_max":280.78,"pressure":1020,"humidity":88,"sea_level":1020,"grnd_level":961}
/// visibility : 10000
/// wind : {"speed":28.61,"deg":310,"gust":36.21}
/// clouds : {"all":100}
/// dt : 1708350240
/// sys : {"type":2,"id":2016284,"country":"PL","sunrise":1708322608,"sunset":1708359539}
/// timezone : 3600
/// id : 7531962
/// name : "Podgórzyn"
/// cod : 200

WeatherModels testFromJson(String str) => WeatherModels.fromJson(json.decode(str));
String testToJson(WeatherModels data) => json.encode(data.toJson());
class WeatherModels {
  WeatherModels({
      Coord? coord, 
  ...
  WeatherModels.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
WeatherModels copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WeatherModels(  coord: coord ?? _coord,
